...
class ContactModel6DLoopTpl : public KinematicConstraintModelAbstractTpl<_Scalar> {
 public:
...
template <typename _Scalar>
struct ContactData6DLoopTpl : public KinematicConstraintDataAbstractTpl<_Scalar> {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
